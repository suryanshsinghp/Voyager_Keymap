...
static bool AS_toggle_bool = true;
...
static bool shft_held = false;
static bool shft_skip = false;
static uint32_t ctrl_timer = 0;
static bool ctrl_held = false;
static bool ctrl_skip = false;
static uint32_t alt_timer = 0;
static bool alt_skip = false;
static bool alt_held = false;
static bool gui_skip = false;
static uint32_t gui_timer = 0;
static bool gui_held = false;
#define ModHoldTime 120
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
      CM_TOGG,        KC_Q,           KC_G,           KC_F,           KC_P,           KC_NO,                                          KC_NO,          KC_L,           KC_U,           KC_Y,           KC_Z,          AS_TOGGLE, 
      CLRMODS,        KC_A,           KC_R,           KC_S,           KC_T,           KC_X,                                           KC_J,           KC_N,           KC_E,           KC_I,           KC_O,          OSM(MOD_RSFT),  
      OSM(MOD_RSFT),  KC_V,           KC_W,           KC_C,           KC_D,           KC_DEL,                                         TD(DANCE_R1),   KC_H,           KC_M,           KC_B,           KC_K,          KC_NO, 
      QK_RBT,         OSM(MOD_RSFT),  OSM(MOD_RALT),  OSM(MOD_RGUI),  OSM(MOD_RCTL),  SH_MON,                                         TD(DANCE_29),   KC_LEFT,        KC_DOWN,        KC_RIGHT,       KC_UP,         KC_NO,   
                                                    LT(1, KC_ENTER),  TT(2),                                         KC_BSPC,   KC_SPACE
  ),
  [1] = LAYOUT_voyager(
      TO(0),          KC_NO,          TD(DANCE_0),    TD(DANCE_1),    TD(DANCE_2),    KC_NO,                                          KC_NO,          TD(DANCE_11),   TD(DANCE_12),   TD(DANCE_13),   KC_NO,          KC_NO,          
      SH_TT,          TD(DANCE_3),    TD(DANCE_4),    TD(DANCE_5),    TD(DANCE_6),    KC_NO,                                          KC_NO,          TD(DANCE_14),   TD(DANCE_15),   TD(DANCE_16),   TD(DANCE_17),   SH_TT,          
      TD(DANCE_R2),   TD(DANCE_7),    TD(DANCE_8),    TD(DANCE_9),    TD(DANCE_10),   KC_NO,                                          KC_NO,          TD(DANCE_18),   TD(DANCE_19),   TD(DANCE_20),   LLOCK,          KC_NO,          
      QK_RBT,         KC_PAGE_UP,     KC_PGDN,        KC_HOME,        KC_END,         SH_MON,                                         TD(DANCE_27),   OSM(MOD_RCTL),  OSM(MOD_RGUI),  OSM(MOD_RALT),  OSM(MOD_RSFT),  KC_NO,          
                                                    TD(DANCE_22),     TT(2),                                          KC_BSPC,  KC_DEL
  ),
  [2] = LAYOUT_voyager(
      TO(0),          KC_NO,          MM_SPEED,       KC_MS_BTN3,     MW_SPEED,       KC_BRIGHTNESS_UP,                               KC_F1,   SCRL_UP,           KC_MS_UP,        M_OS,            KC_NO,               KC_F12,          
      KC_CAPS,        TD(DANCE_24),   TD(DANCE_25),   KC_MS_BTN2,     KC_MS_BTN1,     KC_BRIGHTNESS_DOWN,                             KC_F2,   KC_MS_LEFT,        KC_MS_DOWN,      KC_MS_RIGHT,     KC_NO,               KC_F11,          
      KC_NO,          M_SHFT,         M_ALT,          M_GUI,          M_CTRL,         KC_AUDIO_VOL_UP,                                KC_F3,   SCRL_DN,           SCRL_LF,         SCRL_RT,         LLOCK,               KC_F10,
      QK_RBT,         KC_TAB,         KC_ENTER,       KC_ESC,         KC_DEL,         TD(DANCE_21),                                   KC_F4,   KC_F5,             KC_F6,           KC_F7,           KC_F8,               KC_F9,           
                                                    TD(DANCE_31),     TD(DANCE_30),                                   TD(DANCE_25), KC_MS_ACCEL1
  ),
};
// clang-format on
const uint16_t PROGMEM combo0[] = { KC_N, KC_H, COMBO_END}; //0 CTRL
const uint16_t PROGMEM combo1[] = { KC_R, KC_W, COMBO_END}; //0 home page up
const uint16_t PROGMEM combo2[] = { KC_T, KC_D, COMBO_END}; //0 end page down
const uint16_t PROGMEM combo3[] = { TT(2), LT(1, KC_ENTER), COMBO_END}; //0 to 1 with swap
//const uint16_t PROGMEM combo4[] = { KC_BSPC, KC_SPACE, COMBO_END}; //0 DEL
//const uint16_t PROGMEM combo5[] = { LT(1, KC_ENTER),KC_BSPC , COMBO_END}; //0 to 1
const uint16_t PROGMEM combo6[] = { KC_G, KC_F, COMBO_END}; //0 clrmods
const uint16_t PROGMEM combo7[] = { KC_N, KC_E, COMBO_END}; //0 tab
const uint16_t PROGMEM combo8[] = { KC_G, KC_R, COMBO_END}; //0 DEL
const uint16_t PROGMEM combo9[] = { KC_O, KC_K, COMBO_END}; //0 shift
const uint16_t PROGMEM combo10[] = { KC_B, KC_I, COMBO_END}; //0 alt
const uint16_t PROGMEM combo11[] = { KC_E, KC_I, COMBO_END}; //0 ESC
//const uint16_t PROGMEM combo12[] = { KC_MS_BTN2, KC_MS_BTN1, COMBO_END}; //2 double click
...
//const uint16_t PROGMEM combo19[] = { TD(DANCE_0), TD(DANCE_4), COMBO_END}; //1 clrmods
//const uint16_t PROGMEM combo20[] = { KC_Y, KC_I, COMBO_END}; //0 R1 macro
//const uint16_t PROGMEM combo21[] = { KC_U, KC_Y, COMBO_END}; //0 leader
const uint16_t PROGMEM combo22[] = { KC_Q, KC_A, COMBO_END}; //0 q
const uint16_t PROGMEM combo23[] = { KC_O, KC_Z, COMBO_END}; //0 z
const uint16_t PROGMEM combo24[] = { KC_MS_BTN2, KC_MS_BTN1, COMBO_END}; //hold mouse button 1
const uint16_t PROGMEM combo25[] = { TD(DANCE_0), TD(DANCE_4), COMBO_END}; //1 esc
const uint16_t PROGMEM combo26[] = { KC_L, KC_N, COMBO_END}; //0 j
const uint16_t PROGMEM combo27[] = { KC_P, KC_T, COMBO_END}; //0 x
const uint16_t PROGMEM combo28[] = { KC_U, KC_E, COMBO_END}; //0 Caps
//const uint16_t PROGMEM combo29[] = { KC_M, KC_DOWN, COMBO_END}; //0 up
const uint16_t PROGMEM combo30[] = { TD(DANCE_14), TD(DANCE_15), COMBO_END}; //1 space
const uint16_t PROGMEM combo31[] = { TD(DANCE_15), TD(DANCE_16), COMBO_END}; //1 enter
const uint16_t PROGMEM combo32[] = { TD(DANCE_12), TD(DANCE_15), COMBO_END}; //1 tab
const uint16_t PROGMEM combo33[] = { TD(DANCE_13), TD(DANCE_16), COMBO_END}; //1 tab
//const uint16_t PROGMEM combo33[] = { KC_MS_BTN2, SCRL_DN, COMBO_END}; //2 gui
//const uint16_t PROGMEM combo34[] = { KC_MS_BTN1,KC_MS_BTN2, COMBO_END}; //2 ctrl
const uint16_t PROGMEM combo35[] = { KC_A, KC_V, COMBO_END}; //0 leader
const uint16_t PROGMEM combo36[] = { KC_E, KC_M, COMBO_END}; //0 gui
const uint16_t PROGMEM combo37[] = { KC_T, KC_S, COMBO_END}; //0 right
const uint16_t PROGMEM combo38[] = { KC_S, KC_R, COMBO_END}; //0 left
const uint16_t PROGMEM combo39[] = { KC_F, KC_S, COMBO_END}; //0 up
const uint16_t PROGMEM combo40[] = { KC_S, KC_C, COMBO_END}; //0 down
//const uint16_t PROGMEM combo41[] = { KC_UP, SCRL_UP, COMBO_END}; //2 llock
//const uint16_t PROGMEM combo42[] = { TD(DANCE_0), TD(DANCE_1), COMBO_END}; //1 rep
//const uint16_t PROGMEM combo43[] = { KC_R, KC_G, COMBO_END}; //TO 1 




combo_t key_combos[COMBO_COUNT] = {
    COMBO(combo0, OSM(MOD_RCTL)),
    COMBO(combo1, TD(DANCE_23)),
    COMBO(combo2, TD(DANCE_26)),
    COMBO(combo3, TO(1)),//TO_ONE_SWAP
    //COMBO(combo4, KC_DEL),
    //COMBO(combo5, TO(1)),
    COMBO(combo6, CLRMODS),
    COMBO(combo7, KC_TAB),
    COMBO(combo8, KC_DEL),
    COMBO(combo9, OSM(MOD_RSFT)),
    COMBO(combo10, OSM(MOD_RALT)),
    COMBO(combo11, KC_ESC),
    //COMBO(combo12, ST_MACRO_0),
    //COMBO(combo13, KC_ENTER),
    //COMBO(combo14, KC_SPACE),
    COMBO(combo15, KC_RIGHT),
    COMBO(combo16, KC_LEFT),
    COMBO(combo17, KC_UP),
    COMBO(combo18, KC_DOWN),
    //COMBO(combo19, CLRMODS),
    //COMBO(combo20,TD(DANCE_R1)),
    //COMBO(combo21,  TD(DANCE_29)),
    COMBO(combo22, KC_Q),
    COMBO(combo23, KC_Z),
    COMBO(combo24, HOLD_MB1),
    COMBO(combo25, KC_ESC),
    COMBO(combo26, KC_J),
    COMBO(combo27, KC_X),
    COMBO(combo28, CW_TOGG),
    //COMBO(combo29, KC_UP),
    COMBO(combo30, KC_SPACE),
    COMBO(combo31, KC_ENTER),
    COMBO(combo32, KC_TAB),
    COMBO(combo33, KC_ESC),
    //COMBO(combo34, HOLD_MB1),
    COMBO(combo35, TD(DANCE_29)),
    COMBO(combo36, OSM(MOD_RGUI)),
    COMBO(combo37, KC_RIGHT),
    COMBO(combo38, KC_LEFT),
    COMBO(combo39, KC_UP),
    COMBO(combo40, KC_DOWN),
    //COMBO(combo41, LLOCK),
    //COMBO(combo42, TD(DANCE_27)),
    //COMBO(combo43, TO(1))
};
...
uint16_t get_tapping_term(uint16_t keycode, keyrecord_t *record) {
    switch (keycode) {
        ...
        case TD(DANCE_21):
            return TAPPING_TERM -35;
        case TD(DANCE_22):
            return TAPPING_TERM -25; // layer 2 tap Dance
        case TD(DANCE_23):
        ...
        case TD(DANCE_27):
            return TAPPING_TERM -30;
        case TD(DANCE_28):
            return TAPPING_TERM -15;  // esc tab
        case TD(DANCE_29):
            return TAPPING_TERM +30;
        case TD(DANCE_30):
            return TAPPING_TERM -25; //layer 1 tap dance
        case TD(DANCE_31):
            return TAPPING_TERM -25; // for mouse button 1.
        case TD(DANCE_R1):
  ...
  switch (keycode) {
    ...
    case M_SHFT:  // Toggles key
        ...
        register_code16(KC_RSFT);
            ...
            if (timer_elapsed32(shft_timer) > ModHoldTime) {  // If timer is less than 200ms.
                        unregister_code16(KC_RSFT); 
                } else {  // If timer is more than 200ms.
                    shft_held=true;  // unregister shift hold in matrix_scan_user.
                }
            }
        }
    return false;
    ...
    case M_CTRL:  // Toggles key
        ...
        if (ctrl_held){
            ...
            if (timer_elapsed32(ctrl_timer) > ModHoldTime) {  // If timer is less than 200ms.
                   
                        unregister_code16(KC_RCTL);   
                } else {  // If timer is more than 200ms.
                    ctrl_held=true;  // unregister shift hold in matrix_scan_user.
                }
            }
        }
    return false;
    ...
    case M_ALT:  // Toggles key
        ...
        if(alt_held){
            ...
            if (timer_elapsed32(alt_timer) > ModHoldTime) {  // If timer is less than 200ms.
                        unregister_code16(KC_RALT); 
                } else {  // If timer is more than 200ms.
                    alt_held=true;  // unregister shift hold in matrix_scan_user.
                }
            }
        }
    return false;
    ...
    case M_GUI:  // Toggles key
        ...
        gui_timer = timer_read32();  // Start timer.
            ...
            if (timer_elapsed32(gui_timer) > ModHoldTime) {  // If timer is less than 200ms.
                        unregister_code16(KC_RGUI); 
                } else {  // If timer is more than 200ms.
                    gui_held=true;  // unregister shift hold in matrix_scan_user.
                }
            }
        }
...
void dance_0_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[0].step) {
        case SINGLE_TAP: register_code16(KC_LABK); 
        MemkeywithMod(KC_LABK);
        break;
        case SINGLE_HOLD: register_code16(KC_RABK); 
        MemkeywithMod(KC_RABK);
        break;
        case DOUBLE_TAP: register_code16(KC_LABK); register_code16(KC_LABK); break;
        case DOUBLE_HOLD: register_code16(KC_LABK); break;
...
void dance_0_reset(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[0].step) {
        ...
        case DOUBLE_HOLD: unregister_code16(KC_LABK); break;
...
void dance_1_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[1].step) {
        case SINGLE_TAP: register_code16(KC_MINUS); 
        MemkeywithMod(KC_MINUS);
        break;
        case SINGLE_HOLD: register_code16(KC_UNDS); 
...
void dance_1_reset(tap_dance_state_t *state, void *user_data) {
    wait_ms(10);
    switch (dance_state[1].step) {
        case SINGLE_TAP: unregister_code16(KC_MINUS); 
        if (is_caps_word_on()){
            caps_word_off();
        }
        break;
...
void dance_2_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[2].step) {
        case SINGLE_TAP: register_code16(KC_EQUAL); 
        MemkeywithMod(KC_EQUAL);
        break;
        case SINGLE_HOLD: register_code16(KC_PLUS);
...
void dance_3_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[3].step) {
        case SINGLE_TAP: register_code16(KC_GRAVE); 
        MemkeywithMod(KC_GRAVE);
        break;
        case SINGLE_HOLD: register_code16(KC_TILD); 
...
void dance_4_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[4].step) {
        case SINGLE_TAP: register_code16(KC_QUOTE); 
        MemkeywithMod(KC_QUOTE);
        break;
        case SINGLE_HOLD: register_code16(KC_DQUO); 
...
void dance_5_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[5].step) {
        case SINGLE_TAP: register_code16(KC_COMMA); 
        MemkeywithMod(KC_COMMA);
        break;
        case SINGLE_HOLD: register_code16(KC_SCLN); 
...
void dance_6_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[6].step) {
        case SINGLE_TAP: register_code16(KC_DOT); 
        MemkeywithMod(KC_DOT);
        break;
        case SINGLE_HOLD: register_code16(KC_COLN); 
        MemkeywithMod(KC_COLN);
        break;
        case DOUBLE_TAP: register_code16(KC_DOT); register_code16(KC_DOT); break;
        case DOUBLE_HOLD: register_code16(KC_DOT); break;
...
void dance_7_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[7].step) {
        case SINGLE_TAP: register_code16(KC_LCBR); 
        MemkeywithMod(KC_LCBR);
        break;
        case SINGLE_HOLD: register_code16(KC_RCBR); 
...
void dance_8_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[8].step) {
        case SINGLE_TAP: register_code16(KC_LBRC); 
        MemkeywithMod(KC_LBRC);
        break;
        case SINGLE_HOLD: register_code16(KC_RBRC); 
...
void dance_9_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[9].step) {
        case SINGLE_TAP: register_code16(KC_SLASH); 
        MemkeywithMod(KC_SLASH);
        break;
        case SINGLE_HOLD: register_code16(KC_BSLS); 
...
void dance_10_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[10].step) {
        case SINGLE_TAP: register_code16(KC_ASTR); 
        MemkeywithMod(KC_ASTR);

        break;
        case SINGLE_HOLD: register_code16(KC_CIRC); 
...
void dance_11_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[11].step) {
        case SINGLE_TAP: register_code16(KC_7); 
        MemkeywithMod(KC_7);
       
        break;
        case SINGLE_HOLD: register_code16(KC_AMPR); 
...
void dance_12_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[12].step) {
        case SINGLE_TAP: register_code16(KC_8); 
        MemkeywithMod(KC_8);
        break;
        case SINGLE_HOLD: register_code16(KC_LPRN); 
...
void dance_13_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[13].step) {
        case SINGLE_TAP: register_code16(KC_9); 
        MemkeywithMod(KC_9);
     
        break;
        case SINGLE_HOLD: register_code16(KC_RPRN); 
...
void dance_14_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[14].step) {
        case SINGLE_TAP: register_code16(KC_4); 
         MemkeywithMod(KC_4);
       
        break;
        case SINGLE_HOLD: register_code16(KC_DLR); 
...
void dance_14_reset(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[14].step) {
        ...
        case SINGLE_HOLD: unregister_code16(KC_DLR); 
        if (is_caps_word_on()){
            caps_word_off();
        }
        break;
...
void dance_15_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[15].step) {
        case SINGLE_TAP: register_code16(KC_5); 
            MemkeywithMod(KC_5);
      
        break;
        case SINGLE_HOLD: register_code16(KC_PERC); 
...
void dance_15_reset(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[15].step) {
        ...
        case SINGLE_HOLD: unregister_code16(KC_PERC); 
        if (is_caps_word_on()){
            caps_word_off();
        }
        break;
...
void dance_16_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[16].step) {
        case SINGLE_TAP: register_code16(KC_6); 
         MemkeywithMod(KC_6);
      
        break;
        case SINGLE_HOLD: register_code16(KC_QUES); 
...
void dance_16_reset(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[16].step) {
        ...
        case SINGLE_HOLD: unregister_code16(KC_QUES); 
        if (is_caps_word_on()){
            caps_word_off();
        }
        break;
...
void dance_17_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[17].step) {
        case SINGLE_TAP: register_code16(KC_0); 
         MemkeywithMod(KC_0);
     
        break;
        case SINGLE_HOLD: register_code16(KC_PIPE); 
...
void dance_17_reset(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[17].step) {
        ...
        case SINGLE_HOLD: unregister_code16(KC_PIPE); 
        if (is_caps_word_on()){
            caps_word_off();
        }
        break;
...
void dance_18_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[18].step) {
        case SINGLE_TAP: register_code16(KC_1); 
        MemkeywithMod(KC_1);
...
void dance_19_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[19].step) {
        case SINGLE_TAP: register_code16(KC_2); 
         MemkeywithMod(KC_2);
      
        break;
        case SINGLE_HOLD: register_code16(KC_AT); 
         MemkeywithMod(KC_AT);
...
void dance_19_reset(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[19].step) {
        ...
        case SINGLE_HOLD: unregister_code16(KC_AT);
        if (is_caps_word_on()){
            caps_word_off();
        }
         break;
...
void dance_20_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[20].step) {
        case SINGLE_TAP: register_code16(KC_3); 
         MemkeywithMod(KC_3);
      
        break;
        case SINGLE_HOLD: register_code16(KC_HASH); 
...
void dance_20_reset(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[20].step) {
        ...
        case SINGLE_HOLD: unregister_code16(KC_HASH); 
        if (is_caps_word_on()){
            caps_word_off();
        }
        break;
...
void dance_21_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[21].step) {
        case SINGLE_TAP: tap_code16(KC_AUDIO_MUTE); break;
        case SINGLE_HOLD: register_code16(KC_AUDIO_VOL_DOWN); break;
        case DOUBLE_TAP: tap_code16(KC_AUDIO_VOL_DOWN); tap_code16(KC_AUDIO_VOL_DOWN); break;
        case DOUBLE_SINGLE_TAP: tap_code16(KC_AUDIO_VOL_DOWN); tap_code16(KC_AUDIO_VOL_DOWN);
    }
}
...
void dance_22_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[22].step) {
        case SINGLE_TAP: layer_move(0); 
        break;
        case SINGLE_HOLD: layer_move(0); 
        break;
        case DOUBLE_TAP:  break;
...
void on_dance_23(tap_dance_state_t *state, void *user_data) {
    if(state->count > 2) {
        tap_code16(KC_PAGE_UP);tap_code16(KC_PAGE_UP);tap_code16(KC_PAGE_UP);
    }
}
...
void dance_23_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[23].step) {
        ...
        case DOUBLE_TAP: tap_code16(KC_PAGE_UP);tap_code16(KC_PAGE_UP); break;
...
void on_dance_26(tap_dance_state_t *state, void *user_data) {
    ...
    if(state->count > 2) {
        tap_code16(KC_PGDN);tap_code16(KC_PGDN);tap_code16(KC_PGDN);
    }
}
...
void dance_26_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[26].step) {
        ...
        case DOUBLE_TAP: tap_code16(KC_PGDN);tap_code16(KC_PGDN); break;
...
void on_dance_27(tap_dance_state_t *state, void *user_data) {
    if(state->count == 3) {
        register_mods(saved_mods);tap_code16(mem_keycode);tap_code16(mem_keycode);
        tap_code16(mem_keycode);unregister_mods(saved_mods);
    }
}
...
void dance_27_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[27].step) {
        ...
        case SINGLE_HOLD:
        register_mods(saved_mods);
        register_code16(mem_keycode);break;
        case DOUBLE_TAP: register_mods(saved_mods);tap_code16(mem_keycode);
            tap_code16(mem_keycode);unregister_mods(saved_mods);
        break;
        case DOUBLE_HOLD:  register_mods(saved_mods); tap_code16(mem_keycode);tap_code16(mem_keycode);tap_code16(mem_keycode);
        tap_code16(mem_keycode); unregister_mods(saved_mods); break;
        case DOUBLE_SINGLE_TAP:  break;
    }
}
...
void dance_27_reset(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[27].step) {
        case SINGLE_TAP:  break;
        case SINGLE_HOLD:unregister_code16(mem_keycode);
        unregister_mods(saved_mods); break;
        case DOUBLE_TAP: break;
        case DOUBLE_HOLD: break;
        case DOUBLE_SINGLE_TAP: break;
    }
...
void dance_28_finished(tap_dance_state_t *state, void *user_data) {// WRONG incorrect
    ...
    switch (dance_state[28].step) {
        ...
        tap_code16(KC_TAB);tap_code16(KC_TAB);
         break;
        case DOUBLE_HOLD: register_code16(KC_ESC); MemkeywithMod(KC_ESC); break;
        case DOUBLE_SINGLE_TAP: break;
    }
}
...
void dance_28_reset(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[28].step) {
        ...
        case DOUBLE_TAP:  break;
        case DOUBLE_HOLD: unregister_code16(KC_ESC);break;
        case DOUBLE_SINGLE_TAP: break;
    }
...
void dance_29_reset(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[29].step) {
        case SINGLE_TAP: break;
        case SINGLE_HOLD:  LeaderRepPressed = false; break;
        case DOUBLE_TAP: break;
        case DOUBLE_HOLD: break;
        case DOUBLE_SINGLE_TAP:break;
    }
...
void dance_30_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[30].step) {
        case SINGLE_TAP: layer_move(1); 
        break;
        case SINGLE_HOLD: layer_move(1); 
        break;
        case DOUBLE_TAP:  break;
        case DOUBLE_HOLD: break;
        case DOUBLE_SINGLE_TAP:break;
...
void dance_R2_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[33].step) {
        ...
        case DOUBLE_HOLD: Mem2RepPressed=true; break;
        case DOUBLE_SINGLE_TAP: break;
    }
}
...
void dance_R2_reset(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[33].step) {
        case SINGLE_TAP:  break;
        case SINGLE_HOLD:Mem2RepPressed=false; break;
        case DOUBLE_TAP:  break;
        case DOUBLE_HOLD: break;
        case DOUBLE_SINGLE_TAP: break;
    }
...
tap_dance_action_t tap_dance_actions[] = {
        ...
        [DANCE_R1] = ACTION_TAP_DANCE_FN_ADVANCED(on_dance_R1, dance_R1_finished, dance_R1_reset),
        [DANCE_R2] = ACTION_TAP_DANCE_FN_ADVANCED(on_dance_R2, dance_R2_finished, dance_R2_reset),
};
...
void leader_end_user(void) {
    ...
    if (leader_sequence_one_key(KC_S)) {
            mem_keycode_Leader[0] = KC_S; countLeader = 1;
        if (onMac) {
            ...
            mem_keycode_Leader[0] = KC_L; countLeader = 1;
        if (onMac) {
            tap_code16(RALT(RSFT(KC_LEFT))); LeadExec=true;
        } else if (onWin) {
            tap_code16(RCTL(RSFT(KC_LEFT))); LeadExec=true;
        }
    }

    else if (leader_sequence_one_key(KC_R)) { // select right word by word
            mem_keycode_Leader[0] = KC_R; countLeader = 1;
        if (onMac) {
            tap_code16(RALT(RSFT(KC_RIGHT))); LeadExec=true;
        } else if (onWin) {
            tap_code16(RCTL(RSFT(KC_RIGHT))); LeadExec=true;
        }
    }

    else if (leader_sequence_one_key(KC_H)) {
        mem_keycode_Leader[0] = KC_N; countLeader = 1;
        tap_code16(RCTL(RSFT(KC_1))); LeadExec=true;
   }
   else if (leader_sequence_one_key(KC_M)) {
    mem_keycode_Leader[0] = KC_M; countLeader = 1;
    tap_code16(RCTL(RSFT(KC_2))); LeadExec=true;
    }
    else if (leader_sequence_one_key(KC_B)) {
        mem_keycode_Leader[0] = KC_B; countLeader = 1;
        tap_code16(RCTL(RSFT(KC_3))); LeadExec=true;
    }
    else if (leader_sequence_one_key(KC_K)) {
        mem_keycode_Leader[0] = KC_K; countLeader = 1;
        tap_code16(RCTL(RSFT(KC_4))); LeadExec=true;
    }
    else if (leader_sequence_one_key(KC_N)) {
        mem_keycode_Leader[0] = KC_N; countLeader = 1;
        tap_code16(RCTL(KC_1)); LeadExec=true;
    }
    else if (leader_sequence_one_key(KC_E)) {
        mem_keycode_Leader[0] = KC_E; countLeader = 1;
        tap_code16(RCTL(KC_2)); LeadExec=true;
    }
    else if (leader_sequence_one_key(KC_I)) {
        mem_keycode_Leader[0] = KC_I; countLeader = 1;
        tap_code16(RCTL(KC_3)); LeadExec=true;
    }
    else if (leader_sequence_one_key(KC_O)) {
        mem_keycode_Leader[0] = KC_O; countLeader = 1;
        tap_code16(RCTL(KC_4)); LeadExec=true;
    }
        ...
        mem_keycode_Leader[0] = KC_P; mem_keycode_Leader[1] = KC_R; countLeader = 2;
        SEND_STRING("suryansh"); LeadExec = true;
     }

     else if (leader_sequence_two_keys(KC_G, KC_C)) { // git commit
        mem_keycode_Leader[0] = KC_G; mem_keycode_Leader[1] = KC_C; countLeader = 2;
        //SEND_STRING("git add ."); 
        //tap_code16(KC_ENTER);
        //wait_ms(100);
        SEND_STRING("git add . && git commit -m "); 
        tap_code16(KC_DQUO);tap_code16(KC_DQUO);tap_code16(KC_LEFT); LeadExec = true;
     }
    // APPLICATIONS
    else if (leader_sequence_two_keys(KC_A, KC_T)) {
        mem_keycode_Leader[0] = KC_A; mem_keycode_Leader[1] = KC_T; countLeader = 2;
        if (onMac) {
        tap_code16(RALT(RCTL(RSFT(RGUI(KC_T))))); LeadExec=true;
    } else if (onWin) {
        tap_code16(RALT(RCTL(RSFT(KC_T)))); LeadExec=true;
    }
    }

    else if (leader_sequence_two_keys(KC_A, KC_C)) {  //vs  code
        mem_keycode_Leader[0] = KC_A; mem_keycode_Leader[1] = KC_C; countLeader = 2;
        if (onMac) {
        tap_code16(RALT(RCTL(RSFT(RGUI(KC_V))))); LeadExec=true;
    } else if (onWin) {
        tap_code16(RALT(RCTL(RSFT(KC_V)))); LeadExec=true;
    }
    }

    else if (leader_sequence_two_keys(KC_A, KC_B)) {  //web browser
        mem_keycode_Leader[0] = KC_A; mem_keycode_Leader[1] = KC_B; countLeader = 2;
        if (onMac) {
        tap_code16(RALT(RCTL(RSFT(RGUI(KC_S))))); LeadExec=true;
    } else if (onWin) {
        tap_code16(RALT(RCTL(RSFT(KC_S)))); LeadExec=true;
    }
    }

    else if (leader_sequence_two_keys(KC_G, KC_S)) {  //quick google search
        mem_keycode_Leader[0] = KC_G; mem_keycode_Leader[1] = KC_S; countLeader = 2;
        if (onMac) {
        tap_code16(RALT(RCTL(RSFT(RGUI(KC_G))))); LeadExec=true;
    }
    }

    else if (leader_sequence_two_keys(KC_C, KC_P)) {  //code cmd pallete
        mem_keycode_Leader[0] = KC_C; mem_keycode_Leader[1] = KC_P; countLeader = 2;
        if (onMac) {
        tap_code16(RSFT(RGUI(KC_P))); LeadExec=true;
    } else if (onWin) {
        tap_code16(RSFT(RCTL(KC_P))); LeadExec=true;
    }
    }

    else if (leader_sequence_two_keys(KC_C, KC_D)) {   //code copy line down
        mem_keycode_Leader[0] = KC_C; mem_keycode_Leader[1] = KC_D; countLeader = 2;
        tap_code16(RSFT(RALT(KC_DOWN))); LeadExec=true;
    }

     else if (leader_sequence_two_keys(KC_D, KC_L)) {  //code delete line
        mem_keycode_Leader[0] = KC_D; mem_keycode_Leader[1] = KC_L; countLeader = 2;
        if (onMac) {
        tap_code16(RSFT(RGUI(KC_K))); LeadExec=true;
    } else if (onWin) {
        tap_code16(RSFT(RCTL(KC_K))); LeadExec=true;
    }
    }

    else if (leader_sequence_two_keys(KC_M, KC_B)) {  //code match brackets
        mem_keycode_Leader[0] = KC_M; mem_keycode_Leader[1] = KC_B; countLeader = 2;
        if (onMac) {
        tap_code16(RSFT(RGUI(KC_BSLS))); LeadExec=true;
    } else if (onWin) {
        tap_code16(RSFT(RCTL(KC_BSLS))); LeadExec=true;
    }
    }

    else if (leader_sequence_two_keys(KC_C, KC_B)) {  //put cursor below
        mem_keycode_Leader[0] = KC_C; mem_keycode_Leader[1] = KC_B; countLeader = 2;
        if (onMac) {
        tap_code16(RGUI(KC_ENTER)); LeadExec=true;
    } else if (onWin) {
        tap_code16(RCTL(KC_ENTER)); LeadExec=true;
    }
    }
        ...
        mem_keycode_Leader[0] = KC_C; mem_keycode_Leader[1] = KC_B; countLeader = 2;
        if (onMac) {
        tap_code16(RSFT(RGUI(KC_ENTER))); LeadExec=true;
    } else if (onWin) {
        tap_code16(RSFT(RCTL(KC_ENTER))); LeadExec=true;
    }
    }

    else if (leader_sequence_two_keys(KC_R, KC_F)) {  //revel file
        mem_keycode_Leader[0] = KC_R; mem_keycode_Leader[1] = KC_F; countLeader = 2;
        if (onMac) {
        tap_code16(RGUI(KC_K));tap_code16(KC_R); LeadExec=true;
    } else if (onWin) {
        tap_code16(RCTL(KC_K));tap_code16(KC_R); LeadExec=true;
    }
    }

    else if (leader_sequence_two_keys(KC_L, KC_U)) {  //move line up
        mem_keycode_Leader[0] = KC_L; mem_keycode_Leader[1] = KC_U; countLeader = 2;
        tap_code16(RALT(KC_UP)); LeadExec=true;
    }

    else if (leader_sequence_two_keys(KC_L, KC_D)) {  //move line down
        mem_keycode_Leader[0] = KC_L; mem_keycode_Leader[1] = KC_D; countLeader = 2;
        tap_code16(RALT(KC_DOWN)); LeadExec=true;
    }

    else if (leader_sequence_two_keys(KC_T, KC_W)) {  //toggle word wrap
        mem_keycode_Leader[0] = KC_T; mem_keycode_Leader[1] = KC_W; countLeader = 2;
        tap_code16(RALT(KC_Z)); LeadExec=true;
    }

    else if (leader_sequence_two_keys(KC_B, KC_C)) {  //block comment
        mem_keycode_Leader[0] = KC_B; mem_keycode_Leader[1] = KC_C; countLeader = 2;
        tap_code16(RSFT(RALT(KC_A))); LeadExec=true;
    }

    else if (leader_sequence_two_keys(KC_I, KC_S)) {  //insert snippet
        mem_keycode_Leader[0] = KC_I; mem_keycode_Leader[1] = KC_S; countLeader = 2;
        tap_code16(RALT(KC_J)); LeadExec=true;
    }

    else if (leader_sequence_two_keys(KC_N, KC_J)) {  //new jupyter notebook
        mem_keycode_Leader[0] = KC_N; mem_keycode_Leader[1] = KC_J; countLeader = 2;
        tap_code16(RALT(RCTL(RGUI(KC_J)))); LeadExec=true;
    }

    else if (leader_sequence_two_keys(KC_T, KC_F)) {  //terminal focus
        mem_keycode_Leader[0] = KC_T; mem_keycode_Leader[1] = KC_F; countLeader = 2;
        if (onMac) {
        tap_code16(RGUI(KC_T)); LeadExec=true;
    } else if (onWin) {
        tap_code16(RCTL(KC_T)); LeadExec=true;
    }
    }

    else if (leader_sequence_two_keys(KC_E, KC_F)) {  //editor focus
        mem_keycode_Leader[0] = KC_E; mem_keycode_Leader[1] = KC_F; countLeader = 2;
        if (onMac) {
        tap_code16(RGUI(KC_E)); LeadExec=true;
    } else if (onWin) {
        tap_code16(RCTL(KC_E)); LeadExec=true;
    }
    }
    ...
    //// THREE
        ...
        mem_keycode_Leader[0] = KC_N; mem_keycode_Leader[1] = KC_T; mem_keycode_Leader[2] = KC_P; countLeader = 3;
        if (onMac) {
        tap_code16(RSFT(RGUI(KC_T))); LeadExec=true;
    } else if (onWin) {
        tap_code16(RSFT(RCTL(KC_T))); LeadExec=true;
    }
    }
